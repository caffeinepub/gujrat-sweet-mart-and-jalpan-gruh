...
import { DeliveryApprovalStatus, type Order, OrderStatus } from "../backend";
...
import {
  useGetActiveOrdersForDelivery,
  useUpdateOrderStatusByDelivery,
...
function OrderCard({ order }: { order: Order }) {
  ...
  return (
    <Card
      className={`border-2 ${isDelivered ? "border-green-200 bg-green-50/30 dark:bg-green-950/10 dark:border-green-900" : "border-primary/20"}`}
    >
...
export default function Delivery() {
  ...
  const { data: isDeliveryPerson, isLoading: roleLoading } =
    useIsDeliveryPerson();
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Your account is pending admin approval for delivery access. Please
              wait while the admin reviews your request.
            </p>
      ...
      return (
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Your delivery access request has been rejected. Please contact the
