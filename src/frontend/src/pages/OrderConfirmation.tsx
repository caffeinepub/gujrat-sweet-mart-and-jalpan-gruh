              ...
              {upiConfig ? (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Scan the QR code or use the UPI ID above to complete your
                    payment. Your order is confirmed and will be processed once
                    payment is received.
                  </p>
                </div>
              ) : (
                <p className="text-sm text-muted-foreground">
                  UPI details unavailable. Please contact support to complete
                  your payment.
                </p>
              )}
            </div>
              ...
              {order.items.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="flex justify-between bg-muted/30 p-3 rounded"
                  >
                    <span>
