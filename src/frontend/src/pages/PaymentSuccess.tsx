      ...
      if (status.__kind__ === "completed") {
        ...
        if (userPrincipalStr) {
          try {
            ...
            const orderIdNum = Number.parseInt(userPrincipalStr, 10);
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Your payment has been confirmed successfully. Your order has been
          ...
          <div className="bg-card border-2 border-green-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              You will receive a confirmation shortly. Thank you for shopping
              with us!
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              Track your order in <strong>My Orders</strong> to see delivery
              updates.
            </p>
          </div>
          <div className="flex gap-4 justify-center">
