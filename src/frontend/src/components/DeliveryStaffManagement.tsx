    ...
    <div className="max-w-xl">
      <div className="bg-card border-2 border-primary/20 rounded-lg p-6">
        ...
        <div className="flex items-start gap-2 bg-muted/50 rounded-md p-3 mb-6 text-sm text-muted-foreground">
          ...
          <p>
            Enter the principal ID of the delivery person. They can find their
            principal ID by logging in and checking their profile. Once granted,
            they will be able to access the Delivery Dashboard.
          </p>
        </div>
